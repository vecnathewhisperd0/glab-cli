...
func createExpectedList(expected []StackRef) (list.List, error) {
	// generate the expected list. there doesn't seem to be a way to
	// initialize it with values.
	var expectedList list.List
	expectedList.Init()

	for _, ref := range expected {
		expectedList.PushBack(ref)
	}
